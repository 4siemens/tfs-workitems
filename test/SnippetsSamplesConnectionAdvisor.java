...
public class SnippetsSamplesConnectionAdvisor
        implements ConnectionAdvisor
{
    private static final Log log = LogFactory.getLog(SnippetsSamplesConnectionAdvisor.class);

    private final URI httpProxyURI;

    public SnippetsSamplesConnectionAdvisor()
    {
        this(null);
    }

    public SnippetsSamplesConnectionAdvisor(URI httpProxyURI)
    {
